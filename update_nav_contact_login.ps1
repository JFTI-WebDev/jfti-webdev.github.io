# PowerShell script to update Contact Us and Employee Login to be on the same line in navigation
...
foreach ($file in $files) {
    if (Test-Path $file) {
        ...
        $pattern = '(\s*<li class="nav-item"><a class="nav-link" href="/news\.html">News</a></li>\s*<li class="nav-item"><a class="nav-link" href="/contact-us\.html">Contact Us</a></li>\s*<li class="nav-item[^"]*"><a class="[^"]*" href="https://intranet\.jfti\.com">Employee Login</a></li>)'
        $replacement = '        <li class="nav-item"><a class="nav-link" href="/news.html">News</a></li>
        <li class="nav-item d-flex">
          <a class="nav-link" href="/contact-us.html">Contact Us</a>
          <a class="nav-link border ms-2" href="https://intranet.jfti.com">Employee Login</a>
        </li>'
        
        $newContent = $content -replace $pattern, $replacement
        
        # Also handle relative paths for products directory
        $pattern2 = '(\s*<li class="nav-item"><a class="nav-link" href="\.\./news\.html">News</a></li>\s*<li class="nav-item"><a class="nav-link" href="\.\./contact-us\.html">Contact Us</a></li>\s*<li class="nav-item[^"]*"><a class="[^"]*" href="https://intranet\.jfti\.com">Employee Login</a></li>)'
